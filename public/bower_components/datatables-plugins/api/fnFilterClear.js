 ...
 *
 *  @name fnFilterClear
 *  @summary Remove all column and global common.filters applied to a table
...
jQuery.fn.dataTableExt.oApi.fnFilterClear  = function ( oSettings )
{
	...
	/* Remove the search text for the column common.filters - NOTE - if you have input boxes for these
	 * common.filters, these will need to be reset
	 */
